...
def display_terms():
    ...
    print("Please read our terms and conditions:")
    print(terms_and_conditions_guidelines)
    print("\nIf you agree to these terms, you can click the link above if your terminal supports it, or copy and paste the URL into your web browser.")
    print("After reading, please proceed with the agreement process.")
